...
exports.addDummyData = async () => {
    try {
        ...
        await Case.create({ title: "대법원 2018. 7. 19. 선고 2017도17494 전원합의체 판결 사기방조·횡령", detail : "원심판결 중 횡령 부분을 파기하고, 이 부분 사건을 서울남부지방법원에 환송한다. 검사의 나머지 상고를 기각한다.", reason:`상고이유를 판단한다.
        ...
        await Case.create({ title: "대전지방법원 2023. 4. 6. 선고 2022노3417 판결 [사기, 사기미수]", detail : `원심판결 중 피고사건 부분을 파기한다.
        ...
        await Case.create({ title: "울산지방법원 2021. 2. 16. 선고 2020고단4012 판결 [사기, 사기미수]", detail : "피고인을 징역 3년에 처한다.", reason: `범 죄 사 실
        ...
        await Case.create({ title: "춘천지방법원 2020. 10. 14. 선고 2020고단710 판결 [사기방조, 사기미수방조]", detail : `피고인을 징역 1년 6월에 처한다.
        ...
        await Case.create({ title: "부산지방법원 2017. 5. 11. 선고 2015고단1339 판결 [사기, 사기미수]", detail : "피고인을 범죄사실 중 별지 범죄일람표 순번 1 내지 9 기재의 각 죄에 대하여 징역 1년 2월에, 별지 범죄일람표 순번 10, 11 기재의 각 죄에 대하여 징역 4월에 처한다.", reason: `범 죄 사 실
        ...
        await Case.create({ title: "대구고등법원 2021. 12. 23. 선고 2021노276 판결 [특정경제범죄가중처벌등에관한법률위반(사기), 사기, 사기미수, 협박]", detail : `원심판결 중 피고사건 부분(이유무죄 부분 포함)을 파기한다.
        ...
        await Case.create({ title: "대전지방법원 2012. 5. 9. 선고 2012노196 판결 [절도교사(인정된죄명:절도)·위증] [각공2012하,811]", detail : `원심판결 중 위증죄 부분을 파기한다.
        ...
        await Case.create({ title: "부산지방법원 2008. 7. 22. 선고 2008고단2767 판결 [야간방실침입절도, 절도미수, 방실침입]", detail : `피고인을 징역 1년 2월에 처한다.
        ...
        await Case.create({ title: "d대구지방법원 포항지원 2015. 8. 19. 선고 2015고단202, 343(병합), 492(병합) 판결 [야간건조물침입절도{인정된 죄명 특정범죄가중처벌등에관한법률위반(절도)}, 절도{인정된 죄명 특정범죄가중처벌등에관한법률위반(절도)}, 주거침입, 여신전문금융업법위반, 특정범죄가중처벌등에관한법률위반(절도)]", detail : `피고인 A을 징역 4년에, 피고인 B을 징역 2년 6월에 각 처한다.`,reason :`범 죄 사 실
        ...
        await Case.create({ title: "광주지방법원 2021. 10. 6. 선고 2021고단884, 3185(병합) 판결 [특수협박, 절도]", detail : `피고인을 징역 1년에 처한다.
        ...
        await Case.create({ title: "대구지방법원 2017. 6. 21. 선고 2017노133 판결 [마약류관리에관한법률위반(향정)·절도·공무집행방해·상해]", detail : `원심판결을 파기한다.
        ...
        await Case.create({ title: "울산지방법원 2017. 6. 2. 선고 2017노64, 2017노443(병합) 판결 [야간주거침입절도미수, 절도, 주거침입]", detail : `원심판결들을 모두 파기한다.
        ...
        await Case.create({ title: "울산지방법원 2021. 2. 5. 선고 2020고단4654 판결 [주거침입, 절도]", detail : `피고인을 징역 8월에 처한다.`, reason: `범 죄 사 실
        ...
        await Case.create({ title: "부산지방법원 2019. 12. 4. 선고 2019고단4533 판결 [절도]", detail : `피고인을 징역 1년 6월에 처한다.`, reason:`범 죄 사 실
        ...
        await Case.create({ title: "d울산지방법원 2019. 5. 17. 선고 2019고단1052 판결 [절도, 컴퓨터등사용사기]", detail : "피고인을 징역 8개월에 처한다.", reason:`범 죄 사 실
        ...
        await Case.create({ title: "울산지방법원 2015. 1. 8. 선고 2014고단2347, 3753(병합) 판결 [야간주거침입절도, 주거침입, 건조물침입, 야간주거침입절도미수]", detail : `피고인을 징역 8월에 처한다.
